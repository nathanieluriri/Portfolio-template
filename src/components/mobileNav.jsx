      ...
      >
        ...
        <div className="flex flex-col gap-8 dark:bg-black">
          <SheetClose asChild className="dark:bg-black dark:text-white">
            <TransitionLink onClicked={()=> setOpen(false)} href="/" className="hover:underline">
              Home
            </TransitionLink>
          </SheetClose>

          <SheetClose asChild className="dark:bg-black dark:text-white">
            <TransitionLink  onClicked={()=> setOpen(false)} href="/about" className="hover:underline">
              About
            </TransitionLink>
          </SheetClose>
          <SheetClose asChild className="dark:bg-black dark:text-white">
            <TransitionLink  onClicked={()=> setOpen(false)} href="/all-work" className="hover:underline">
              All Work
            </TransitionLink>
          </SheetClose>

          <SheetClose asChild className="dark:bg-black dark:text-white">
            <TransitionLink  onClicked={()=> setOpen(false)} href="/contact" className="hover:underline">
              Contact
            </TransitionLink>
          </SheetClose>
        </div>
