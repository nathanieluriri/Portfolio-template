      ...
      <div className=" flex flex-col justify-self-center">
        ...
        <div className="flex md:flex-row md:justify-between md:p-10 p-3 justify-center flex-col-reverse md:gap-0 gap-14">
          <div className="flex flex-col gap-5">
            <h1 className="md:text-4xl md:w-2/5 text-2xl">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-sm">Streamz</p>
            <p className="text-sm">Cafdash</p>
            <p className="text-sm">Class Insight</p>
            <p className="text-sm">Litebank</p>
          </div>
